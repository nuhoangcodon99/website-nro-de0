                    ...
                    <div class="row text-center justify-content-center row-cols-3 row-cols-lg-6 g-1 g-lg-1"
                        ...
                        <div class="col">
                            <a class="btn btn-sm btn-success w-100 fw-semibold active" href="/Users/Profile"
                                style="background-color: #198754;">Tài khoản</a>
                        </div>
                        <div class="col">
                    ...
                    <table class="table table-border">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><b class="text-danger1"><?= formatMoney($_Coins) ?></b>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">Tổng Nạp</th>
                                <td><b class="text-danger1"><?= formatMoney($_TCoins) ?></b>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><a href="/Users/ChangePassword">Đổi mật khẩu</a></td>
                            </tr>
                            <tr>
